This project is based on the “News Classification Use Case” example in http://www.redbooks.ibm.com/redbooks.nsf/redbookabstracts/sg248391.html?Open

Important considerations:
- I updated the libs in the pom.xml (2018-08)
- The WAR produced by Maven does not contain all files (therefore it does not run on IBM CLoud), basically because the project does not comply with Maven archeotype. I use the Eclipse create WAR function.



---The next text is the original readme of the project:


The project corresponds to task “News Classification Use Case” in Natural Language Classifier API.
A sample application that classify News Text using Natural Language Classifier

...
public class Query {
	...
	public String getStatus(String classifierID,String user, String password){
		NaturalLanguageClassifier nlc = new NaturalLanguageClassifier(user,password);
	...
	public static void main(String[] args){
		...
		String status = query.getStatus(args[0], args[1], args[2]);
		System.out.println("Status of Classifier "+args[0]+" - "+status);
